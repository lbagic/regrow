...
Status: Phase 1 in progress (engine + schema done; TUI next). This doc records structure and invariants; it grows with each phase. Product rationale lives in [PRODUCT.md](PRODUCT.md); build order in [PLAN.md](PLAN.md).
