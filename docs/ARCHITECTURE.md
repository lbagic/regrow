...
Status: Phase 1 complete (engine + schema + TUI + 30-rule catalog); safety hardening (Phase 2) next. This doc records structure and invariants; it grows with each phase. Product rationale lives in [PRODUCT.md](PRODUCT.md); build order in [PLAN.md](PLAN.md).
